...
class MusicalTopView: UIView {
    ...
    func showMainViewTopBtn(){
        ...
        addbtn.addTarget(self, action: Selector("addBtnClickMethod:"), forControlEvents: UIControlEvents.TouchUpInside)
//        addbtn.enabled = false
        ...
        savebtn.addTarget(self, action: Selector("saveBtnClickMethod:"), forControlEvents: UIControlEvents.TouchUpInside)
        ...
        setbtn.addTarget(self, action: Selector("setBtnClickMethod:"), forControlEvents: UIControlEvents.TouchUpInside)
        ...
        switchbtn.addTarget(self, action: Selector("switchClickMethod:"), forControlEvents: UIControlEvents.TouchUpInside)
        ...
        tablebtn.addTarget(self, action: Selector("tableClickMethod:"), forControlEvents: UIControlEvents.TouchUpInside)
